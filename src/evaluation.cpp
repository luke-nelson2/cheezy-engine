...
const std::array<int, 12> GAME_PHASE_INCREMENT = {0, 0, 11, 11, 11, 11, 21, 21, 42, 42, 0, 0};

const std::array<std::array<int, 64>, 6> mg_piece_tables = {
  mg_pawn_table,
  mg_knight_table,
  mg_bishop_table,
  mg_rook_table,
...
const std::array<std::array<int, 64>, 6> eg_piece_tables = {
  eg_pawn_table,
  eg_knight_table,
  eg_bishop_table,
  eg_rook_table,
